...
if [ -d ./deploy/${export_filename}/ ] ; then
	...
	#echo "sudo ./setup_sdcard.sh --img-${filesize} bbai64-emmc-flasher-${export_filename} --dtb bbai64-mainline --enable-extlinux-flasher --hostname BeagleBone-AI64"
	#sudo ./setup_sdcard.sh --img-${filesize} bbai64-emmc-flasher-${export_filename} --dtb bbai64-mainline --enable-extlinux-flasher --hostname BeagleBone-AI64
	#mv ./*.img ../
