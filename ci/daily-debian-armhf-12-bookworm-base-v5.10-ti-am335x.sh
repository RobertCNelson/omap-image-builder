...
config=bb.org-debian-bookworm-base-v5.10-ti-armhf-am335x
filesize=4gb
rootfs="debian-armhf-12-base-v5.10-ti"
...
compress_snapshot_image () {
	...
	echo "- name: BeagleBone Black Debian 12 v5.10.x-ti (Old Compatible)" >> ${yml_file}
