...
config=bb.org-debian-trixie-iot-v6.19-k3-arm64
filesize=8gb
rootfs="debian-arm64-13-iot-v6.19-k3"
...
if [ -d ./deploy/${export_filename}/ ] ; then
	...
	r_name="v6.19.x-k3 IoT (Stable v6.19.x)"
	...
	r_name="v6.19.x-k3 IoT (TechLab Workshop) (Stable v6.19.x)"
