...
debian_lxde_stable="debian-7.10-lxde-armhf-${time}"
debian_lxde_4gb_stable="debian-7.10-lxde-4gb-armhf-${time}"
debian_console_stable="debian-7.10-console-armhf-${time}"
archive="xz -z -8 -v"
