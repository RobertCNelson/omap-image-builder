...
if [ ! -f debian-${debian_stable}-lxqt-armhf-${time}.tar.xz ] ; then
	xz -z -7 -v debian-${debian_stable}-lxqt-armhf-${time}.tar
fi
...
xz -z -7 -v BBB-blank-eMMC-flasher-debian-${debian_stable}-lxqt-${time}-2gb.img
...
xz -z -7 -v BBB-eMMC-flasher-debian-${debian_stable}-lxqt-${time}-2gb.img

if [ -f bone-debian-${debian_stable}-lxqt-${time}-2gb.img.xz ] ; then
	rm bone-debian-${debian_stable}-lxqt-${time}-2gb.img.xz || true
fi
xz -z -7 -v bone-debian-${debian_stable}-lxqt-${time}-2gb.img
