       ...
       debian_stretch_iot_grove_kit="debian-9.13-iot-grove-kit-armhf-${time}"
           ...
           debian_stretch_lxqt_tidl="debian-9.13-lxqt-tidl-armhf-${time}"
             ...
             debian_stretch_wayland="debian-9.13-wayland-armhf-${time}"
                 ...
                 debian_buster_tiny="debian-10.5-tiny-armhf-${time}"
              debian_buster_console="debian-10.5-console-armhf-${time}"
           debian_buster_console_xm="debian-10.5-console-xm-armhf-${time}"
                  debian_buster_iot="debian-10.5-iot-armhf-${time}"
             debian_buster_iot_tidl="debian-10.5-iot-tidl-armhf-${time}"
        debian_buster_iot_grove_kit="debian-10.5-iot-grove-kit-armhf-${time}"
         debian_buster_iot_mikrobus="debian-10.5-iot-mikrobus-armhf-${time}"
              debian_buster_efi_iot="debian-10.5-efi-iot-armhf-${time}"
                 debian_buster_lxqt="debian-10.5-lxqt-armhf-${time}"
            debian_buster_lxqt_tidl="debian-10.5-lxqt-tidl-armhf-${time}"
              debian_buster_lxqt_xm="debian-10.5-lxqt-xm-armhf-${time}"
debian_buster_iot_webthings_gateway="debian-10.5-iot-webthings-gateway-armhf-${time}"
...
pru_rproc_v54ti="--enable-uboot-pru-rproc-54ti"
...
base_rootfs="${debian_stretch_imgtec}" ; blend="stretch-imgtec" ; extract_base_rootfs
...
options="--img-1gb am57xx-\${base_rootfs}               ${beagle_x15}"                                    ; generate_img
options="--img-1gb am57xx-eMMC-flasher-\${base_rootfs}  ${beagle_x15} --emmc-flasher"                     ; generate_img
options="--img-1gb bone-\${base_rootfs}                 ${beaglebone} ${pru_rproc_v54ti}"                ; generate_img
options="--img-1gb bone-eMMC-flasher-\${base_rootfs}    ${beaglebone} ${pru_rproc_v54ti} --emmc-flasher" ; generate_img

options="--img-1gb BBB-blank-\${base_rootfs}            ${beaglebone} ${pru_rproc_v54ti} --bbb-flasher"  ; generate_img
options="--img-1gb BBBL-blank-\${base_rootfs}           ${beaglebone} ${pru_rproc_v54ti} --bbbl-flasher" ; generate_img
options="--img-1gb BBBW-blank-\${base_rootfs}           ${beaglebone} ${pru_rproc_v54ti} --bbbw-flasher" ; generate_img
#options="--img-1gb BBGG-blank-\${base_rootfs}           ${beaglebone} ${pru_rproc_v54ti} --bbgg-flasher" ; generate_img
...
options="--img-4gb am57xx-\${base_rootfs}               ${beagle_x15}"                                    ; generate_img
options="--img-4gb am57xx-eMMC-flasher-\${base_rootfs}  ${beagle_x15} --emmc-flasher"                     ; generate_img
options="--img-4gb bone-\${base_rootfs}                 ${beaglebone} ${pru_rproc_v54ti}"                ; generate_img
options="--img-4gb bone-eMMC-flasher-\${base_rootfs}    ${beaglebone} ${pru_rproc_v54ti} --emmc-flasher" ; generate_img
...
base_rootfs="${debian_buster_iot_mikrobus}" ; blend="buster-iot-mikrobus" ; extract_base_rootfs
...
options="--img-4gb bone-\${base_rootfs}    ${beaglebone} ${pru_rproc_v54ti} --efi" ; generate_img
...
options="--img-6gb am57xx-\${base_rootfs}  ${beagle_x15}"                      ; generate_img
options="--img-6gb bone-\${base_rootfs}    ${beaglebone} ${pru_rproc_v54ti}"  ; generate_img
...
base_rootfs="${debian_stretch_imgtec}"        ; blend="stretch-imgtec"     ; archive_base_rootfs
...
base_rootfs="${debian_buster_iot_tidl}"       ; blend="buster-iot-tidl"   ; archive_base_rootfs
base_rootfs="${debian_buster_iot_grove_kit}"  ; blend="buster-iot-grove-kit"   ; archive_base_rootfs
base_rootfs="${debian_buster_iot_mikrobus}"   ; blend="buster-iot-mikrobus"    ; archive_base_rootfs
...
###DEBIAN STRETCH: imgtec
base_rootfs="${debian_stretch_imgtec}" ; blend="stretch-imgtec"
...
###DEBIAN BUSTER: iot-mikrobus
base_rootfs="${debian_buster_iot_mikrobus}" ; blend="buster-iot-mikrobus"
