...
./RootStock-NG.sh -c bb.org-debian-bullseye-xfce-v5.10-ti-armhf
	...
	mkdir -p ${DIR}/deploy/ || true
         ...
         debian_buster_tiny="debian-10.11-tiny-armhf-${time}"
      debian_buster_console="debian-10.11-console-armhf-${time}"
   debian_buster_console_xm="debian-10.11-console-xm-armhf-${time}"
          debian_buster_iot="debian-10.11-iot-armhf-${time}"
     debian_buster_iot_tidl="debian-10.11-iot-tidl-armhf-${time}"
debian_buster_iot_grove_kit="debian-10.11-iot-grove-kit-armhf-${time}"
 debian_buster_iot_mikrobus="debian-10.11-iot-mikrobus-armhf-${time}"
      debian_buster_efi_iot="debian-10.11-efi-iot-armhf-${time}"
         debian_buster_lxqt="debian-10.11-lxqt-armhf-${time}"
...
debian_bullseye_minimal="debian-11.2-minimal-armhf-${time}"
    debian_bullseye_iot="debian-11.2-iot-armhf-${time}"
   debian_bullseye_xfce="debian-11.2-xfce-armhf-${time}"
