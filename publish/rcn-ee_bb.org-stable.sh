       ...
       debian_stretch_iot_grove_kit="debian-9.13-iot-grove-kit-armhf-${time}"
           ...
           debian_stretch_lxqt_tidl="debian-9.13-lxqt-tidl-armhf-${time}"
             ...
             debian_stretch_wayland="debian-9.13-wayland-armhf-${time}"
                 ...
                 debian_buster_tiny="debian-10.7-tiny-armhf-${time}"
              debian_buster_console="debian-10.7-console-armhf-${time}"
           debian_buster_console_xm="debian-10.7-console-xm-armhf-${time}"
                  debian_buster_iot="debian-10.7-iot-armhf-${time}"
             debian_buster_iot_tidl="debian-10.7-iot-tidl-armhf-${time}"
        debian_buster_iot_grove_kit="debian-10.7-iot-grove-kit-armhf-${time}"
         debian_buster_iot_mikrobus="debian-10.7-iot-mikrobus-armhf-${time}"
              debian_buster_efi_iot="debian-10.7-efi-iot-armhf-${time}"
                 debian_buster_lxqt="debian-10.7-lxqt-armhf-${time}"
            debian_buster_lxqt_tidl="debian-10.7-lxqt-tidl-armhf-${time}"
              debian_buster_lxqt_xm="debian-10.7-lxqt-xm-armhf-${time}"
debian_buster_iot_webthings_gateway="debian-10.7-iot-webthings-gateway-armhf-${time}"
